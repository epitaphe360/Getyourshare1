...
import { Target, Calendar, DollarSign, Tag, FileText, Package, Users, Upload, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Définissez les détails de votre campagne d'affiliation
          </p>
        </div>
      </div>

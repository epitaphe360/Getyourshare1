...
@pytest.mark.unit
@pytest.mark.payments
def test_approve_commission_already_approved(mock_supabase, sample_commission_id, mock_postgres_error):
...
def test_get_commission_by_id_success(mock_supabase, sample_commission_id, sample_commission):
    ...
    # Arrange
    mock_supabase.table.return_value.select.return_value.eq.return_value.execute.return_value.data = [sample_commission]
    service = PaymentsService(mock_supabase)
...
def test_get_commissions_by_status_success(mock_supabase, sample_commission):
    ...
    mock_supabase.table.return_value.select.return_value.eq.return_value.order.return_value.execute.return_value.data = commissions_list
    service = PaymentsService(mock_supabase)
...
@pytest.mark.unit
@pytest.mark.payments
def test_get_commissions_by_influencer_success(mock_supabase, sample_influencer_id, sample_commission):
...
@pytest.mark.unit
@pytest.mark.payments
def test_get_commissions_by_influencer_with_status_filter(mock_supabase, sample_influencer_id, sample_commission):
    """Test filtrage par statut"""
    # Arrange
    mock_supabase.table.return_value.select.return_value.eq.return_value.eq.return_value.order.return_value.execute.return_value.data = [sample_commission]
    service = PaymentsService(mock_supabase)

...
### 1. **create_sale_transaction** - Cr�ation atomique de vente

Cr�e une vente compl�te avec commission, met � jour tous les compteurs et m�triques en une seule transaction atomique.
...
|-----------|------|-------------|-------------|
| p_link_id | UUID |  | ID du lien track� utilis� |
...
#### Validations automatiques
 ...
 Lien correspond au produit ET � l''influenceur  

#### Op�rations atomiques

1. Insertion dans `sales` avec calculs de commissions
2. Cr�ation commission dans `commissions` (status: pending)
3. Mise � jour `trackable_links`, `influencers`, `merchants`, `products`

---

### 2. **approve_payout_transaction** - Gestion des paiements

G�re les transitions de statut des commissions avec ajustement automatique du solde.
